...
const PB_CATS = {
  ...
  "Roofing": [
    {key:"roof_shingles",label:"Shingles",pfx:["Roof Shingles","ROOF SHINGLES"]},
    {key:"roof_underlayment",label:"Underlayment",pfx:["Roof Underlayment","ROOF UNDERLAYMENT"]},
    {key:"roof_flashing",label:"Flashing",pfx:["Roof Flashing","ROOF FLASHING"]},
    {key:"roof_ventilation",label:"Ventilation",pfx:["Roof Ventilation","ROOF VENTILATION"]},
    {key:"roof_gutters",label:"Gutters",pfx:["Gutters","GUTTERS"]},
    {key:"roof_labor",label:"Roofing Labor",pfx:["Roof Labor","ROOF LABOR"]},
    {key:"roof_misc",label:"Miscellaneous",pfx:["Roof Misc","ROOF MISC"]},
  ],
  "Bathroom Extras": [
  ...
  "Roofing Extras": [
    {key:"ext_roof",label:"Roofing Extras",pfx:["Roof Extra","ROOFING EXTRA"]},
  ],
};
